...
const it = {
  ...
  "shell.check":
    "SCACCO al Re {faction} — devi risolvere lo scacco con questa mossa.",
  ...
  "board.chooseState":
    "Scegli lo stato di arrivo della pedina (mossa di 2 passi da",
...
const en: Dict = {
  ...
  "shell.check": "CHECK on the {faction} King — this move must resolve the check.",
  ...
  "board.chooseState": "Choose the arrival flavour of the piece (2-step move from",
