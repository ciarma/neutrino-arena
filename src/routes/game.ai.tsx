...
function DifficultyPicker({ onPick }: { onPick: (d: Difficulty) => void }) {
  ...
  useEffect(() => {
    const onKeyDown = (e: KeyboardEvent) => {
      // Alternative mapping: W/A/S/D = arrows, E = Enter, R = Backspace, X = Esc
      const aliases: Record<string, string> = { w: "ArrowUp", a: "ArrowLeft", s: "ArrowDown", d: "ArrowRight", e: "Enter", r: "Backspace", x: "Escape" };
